...
Download the cifar10 and celeba pretrained model from GoogleDrive [cifar10](https://drive.google.com/file/d/1g0CMKgbrYgL251xIynn8QDFPWbNbVsIz/view?usp=sharing), [celeba](https://drive.google.com/file/d/18LE9E4MQDi3D6GqAs1DOBiOACC4nGp00/view?usp=sharing), and then put the model into the folder saved_models
```
